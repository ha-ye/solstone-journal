...
| Local importer secrets (`~/Library/Application Support/Solstone/secrets/**`) | `solstone/think/importers/local_secrets.py` — machine-local OAuth token material outside journal content, import bundles, indexes, and replicated backups. |
