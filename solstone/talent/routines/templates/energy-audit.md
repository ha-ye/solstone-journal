...
3. Use `journal identity pulse` for the current state narrative.
4. Use `sol call journal news FACET --day YYYYMMDD` for representative days across active facets.
