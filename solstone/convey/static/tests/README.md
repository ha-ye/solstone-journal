...
Open `solstone/convey/static/tests/day-grid.html` in a browser; each assertion reports pass/fail inline for day-grid.js gating, scroll target selection, heat, idempotence, and keyboard behavior.
