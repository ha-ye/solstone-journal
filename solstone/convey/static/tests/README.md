...
Open `solstone/apps/import/static/tests/import-detail.html` in a browser; each assertion reports pass/fail inline for import detail drawer composition, chips, links, and raw payload sections.
