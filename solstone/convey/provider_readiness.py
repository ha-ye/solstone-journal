...
_ENTRIES: dict[str, _Entry] = {
    ...
    "local_server_unhealthy": _Entry(
        klass="provider",
        summary="the local model server is not responding",
    ...
    "provider_quota_exceeded": _Entry(
        klass="provider",
        summary="your {provider} quota is spent — try again later",
    ...
    "provider_unavailable": _Entry(
        klass="provider",
        summary="{provider} is having trouble — try again",
        detail="Try again later or choose another provider.",
        recovery_action=None,
    ),
    "chat_pipeline_unavailable": _Entry(
        klass="generic",
        summary="the chat pipeline isn't ready yet — try again in a moment",
        detail="Try again once chat finishes starting.",
        recovery_action=None,
    ),
    "chat_timeout": _Entry(
        klass="generic",
        summary="chat took too long — try again",
        detail="Try again with a shorter request.",
        recovery_action=None,
    ),
    "no_output": _Entry(
        klass="generic",
        summary="I didn't get a response — try again",
        detail="Try again or choose another provider.",
        recovery_action=None,
    ),
    "unknown": _Entry(
        klass="generic",
        summary="chat had trouble — try again",
        detail="Try again or choose another provider.",
        recovery_action=None,
    ),
}
