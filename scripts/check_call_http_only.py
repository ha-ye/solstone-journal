...
ALLOWLIST: dict[tuple[str, str], int] = {
    ...
    ("solstone/apps/awareness/call.py", "import"): 5,
    ...
    ("solstone/apps/observer/call.py", "import"): 1,
    ("solstone/apps/settings/call.py", "fs"): 3,
    ("solstone/apps/settings/call.py", "import"): 27,
    ("solstone/apps/skills/call.py", "import"): 3,
    ("solstone/apps/sol/call.py", "import"): 8,
