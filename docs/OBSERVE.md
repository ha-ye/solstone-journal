...
- **transcribe/** — Audio transcription with sentence-level embeddings. Exit-code contract, retry/deferral semantics, and the `observe.transcribed` field table: [transcribe/failure-and-telemetry.md](../solstone/observe/transcribe/failure-and-telemetry.md)
